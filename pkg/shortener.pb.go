...
// URLExpandRequest - запрос на получение исходного URL
...
// URLExpandResponse - ответ с исходным URL
...
// UserURLsResponse - ответ со списком URL пользователя
...
// URLData - данные о короткой ссылке
type URLData struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
...
const file_api_shortener_proto_rawDesc = "" +
	"\n" +
	"\x13api/shortener.proto\x12\fshortener.v1\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x1e.shortener.v1.UserURLsResponseB#Z!github.com/Rusich90/shurl.git/pkgb\x06proto3"
